...
names, and a
length-prefixed version 31 `.zir` payload. The current linker follows direct
...
nested arrays and `u8` arrays inside imported records. Indexing is bounds-checked. Version 19 is
