...
This is the target contract. An experimental binary version 32 now exists for
...
been removed; version 32 rejects earlier files before graph validation.
...
text remains diagnostic metadata. Version 32 is experimental and has no
