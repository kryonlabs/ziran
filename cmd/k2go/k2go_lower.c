               ...
               char *name, size_t name_size)
{
    ...
    static const struct {
        ...
        {"ParagraphTextProps", {"Bounds", "Text", "Font", "Color",
                                "LineGap", "Key"}},
        {"LinkProps", {"Bounds", "ClassName", "Text", "Link", "Font", "FocusID",
		...
		{"Tab", {"Label", "Icon", "IconSize", "Disabled", "Accent", "Italic",
		         "Closeable"}},
		{"TabBarProps", {"Bounds", "ClassName", "Tabs", "Count", "SelectedIndex", "Font",
		...
		{"TextProps", {"Bounds", "Text", "Font", "Color", "Wrap", "Align", "VerticalAlign", "Disabled", "LetterSpacing", "Selectable", "Typeface", "ClassName", "Style"}},
          ...
          int no_main, int runtime_implementation)
{
    ...
    if(runtime_implementation) {
        ...
        fprintf(support, "// Code generated by k2go for shared runtime numeric support. DO NOT EDIT.\n");
        fprintf(support, "package %s\n\n", pkg);
        KirEmitNumberSupport(support, KIR_GO, "number_runtime");
        fclose(support);
    }
    return 0;
}
