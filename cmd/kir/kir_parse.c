...
is_web_native_block_widget(const char *name)
{
    static const char *const widgets[] = {
        ...
        "ImageMap", "Inserted", "Italic", "Keyboard", "Label",
        "Legend", "LineBreak",
        "ListItem", "Main", "Mark", "Meta", "Navigation", "NoScript", "EmbeddedObject", "OrderedList", "OptionGroup", "Option", "Output", "Param", "Pre", "Quote",
        "Ruby", "RubyParenthesis", "RubyText",
        "Sample", "Script", "Search", "Select", "Slot", "Small", "Source", "Strong", "StyleElement", "Subscript",
        "Summary", "Superscript", "Table", "TableBody",
        "TableCaption", "TableColumn", "TableColumnGroup", "TableFoot", "TableHead",
        "TableRow", "Template", "Time", "Title", "Track",
        "UnorderedList", "Variable", "Video", "WordBreakOpportunity"
    };
