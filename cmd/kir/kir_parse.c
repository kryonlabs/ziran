                       ...
                       char *args, size_t args_size)
{
    static const char *const widgets[] = {
        ...
        "Mark", "Meter", "Nav", "Navigation", "NoScript", "Noscript", "EmbeddedObject", "OrderedList",
...
is_web_native_block_widget(const char *name)
{
    static const char *const widgets[] = {
        ...
        "Legend",
        "List", "ListItem", "Main", "Mark", "Nav", "Navigation", "NoScript", "Noscript",
        ...
        "TableRow", "Tbody", "Template", "Tfoot", "Thead", "Time", "Tr", "Track",
