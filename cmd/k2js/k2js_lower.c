                         ...
                         char *args, size_t args_size)
{
    static const char *const widgets[] = {
        ...
        "Abbreviation", "Address", "Article", "Aside",
        ...
        "Audio", "Data", "Deleted", "DescriptionDetails",
        "DescriptionList", "DescriptionTerm", "Details", "Dialog",
        "Embed", "Emphasis", "Form", "Header", "IFrame", "Inserted", "Italic", "Keyboard", "Label", "Legend",
        "ListItem", "Main", "Mark", "Meter", "Navigation",
        "OrderedList", "Option", "Output", "Pre", "Quote",
        "Sample", "Select", "Small", "Source", "Strong",
        "Subscript", "Summary", "Superscript",
        "Table", "TableBody", "TableCaption", "TableCell", "TableColumn",
        "TableColumnGroup", "TableFoot", "TableHead", "TableRow",
        "Time", "Track",
        "UnorderedList", "Variable", "Video",
