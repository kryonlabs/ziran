                         ...
                         char *args, size_t args_size)
{
    static const char *const widgets[] = {
        ...
        "Link", "Fieldset", "Figure", "Figcaption", "Footer",
        "Button", "Card", "Selectable", "Checkbox", "Drag", "DragDrop",
        "Dropdown", "Input", "Slider", "Toggle", "Radio", "Spinbox",
        "Audio", "Data", "Del", "Deleted", "DescriptionDetails",
        "DescriptionList", "DescriptionTerm", "Details", "Dialog",
        "Em", "Embed", "Emphasis", "Form", "Header", "IFrame", "Iframe",
        "Ins", "Inserted", "Italic", "Kbd", "Keyboard", "Label",
        "List", "ListItem", "Main", "Mark", "Meter", "Nav", "Navigation",
        "OrderedList", "Option", "Output", "Picture", "Pre", "Quote",
        "Samp", "Sample", "Select", "Small", "Source", "Strong",
        "Sub", "Subscript", "Summary", "Sup", "Superscript",
        "Table", "TableBody", "TableCaption", "TableCell", "TableColumn",
        "TableColumnGroup", "TableFoot", "TableHead", "TableRow",
        "Tbody", "Tfoot", "Thead", "Time", "Tr", "Track",
...
emit_web_metadata(FILE *f, const KirModule *m, const KirStmt *st)
{
    ...
    emit_web_action(f, m, "onInput", "inputAction", st->dom_on_input,
                    "value", &emitted);
    emit_web_action(f, m, "onBeforeInput", "beforeInputAction",
                    st->dom_on_before_input, "value", &emitted);
    emit_web_action(f, m, "onChange", "changeAction", st->dom_on_change,
                    "value", &emitted);
    emit_web_action(f, m, "onSelect", "selectAction", st->dom_on_select,
                    "value", &emitted);
    emit_web_action(f, m, "onKey", "keyAction", st->dom_on_key, "key",
                    &emitted);
    emit_web_action(f, m, "onInvalid", "invalidAction",
                    st->dom_on_invalid, "value", &emitted);
    ...
    emit_web_action(f, m, "onDragEnd", "dragEndAction",
                    st->dom_on_drag_end, "value", &emitted);
